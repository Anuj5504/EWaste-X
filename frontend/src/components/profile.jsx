...
const Profile = () => {
    ...
    const fetchUserPosts = async () => {
        try {
            const response = await fetch(`https://knowcode-hack.onrender.com/api/ewaste/user-posts`, {
                headers: {
    ...
    const fetchRequests = async (postId) => {
        try {
            ...
            if (post.donationOrSale === 'donate') {
                ...
                response = await fetch(`https://knowcode-hack.onrender.com/api/ewaste/${postId}/donation-requests`, {
                    headers: {
                        'Authorization': userInfo.walletAddress
                    }
                });
                ...
                response = await fetch(`https://knowcode-hack.onrender.com/api/bids/${postId}`, {
                    headers: {
                        'Authorization': userInfo.walletAddress
                    }
                });
    ...
    const handleRequestAction = async (requestId, action, type) => {
        try {
            ...
            const response = await fetch(`https://knowcode-hack.onrender.com${endpoint}`, {
                method: 'POST',
                headers: {
                    'Authorization': userInfo.walletAddress,
