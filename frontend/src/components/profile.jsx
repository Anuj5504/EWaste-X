...
const Profile = () => {
    ...
    const fetchRequests = async (postId) => {
        try {
            ...
            const donationResponse = await fetch(`https://knowcode-hack.onrender.com/api/ewaste/${postId}/donation-requests`, {
                headers: {
                    'Authorization': userInfo.walletAddress
                }
            });
            ...
            if (post.donationOrSale === 'sale') {
                const bidsResponse = await fetch(`https://knowcode-hack.onrender.com/api/ewaste/${postId}/bids`, {
                    headers: {
                        'Authorization': userInfo.walletAddress
                    }
                });
