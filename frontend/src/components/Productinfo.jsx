...
const ProductInfo = () => {
    ...
    const fetchBidHistory = async () => {
        try {
            const response = await fetch(`https://knowcode-hack.onrender.com/api/bid/${id}`);
            if (!response.ok) {
    ...
    const handleStopBidding = async () => {
        ...
        try {
            const response = await fetch(`https://knowcode-hack.onrender.com/api/ewaste/${product._id}/status`, {
                method: 'PATCH',
                headers: {
                    'Authorization': userInfo.walletAddress,
                    'Content-Type': 'application/json'
    ...
    const handleDonationRequest = async () => {
        ...
        try {
            const response = await fetch(`https://knowcode-hack.onrender.com/api/ewaste/${id}/donation-request`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': userInfo.walletAddress
